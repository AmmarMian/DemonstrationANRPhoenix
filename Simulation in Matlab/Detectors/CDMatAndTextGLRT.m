%% Description
% SIRV MatAndText GLRT for Change Detection on covariance matrices
%% Specifiactions
...
%% ------------- BEGIN CODE --------------
function ratio = CDMatAndTextGLRT(Data, Args)
% SIRV MatAndText GLRT for Change Detection on covariance matrices
% Syntax:  ratio = CDMatAndTextGLRT(Data, Args)
% Inputs:
